...
export const metadata: Metadata = {
  ...
  description:
    'NUKITORU FOODとNUKITORU SCAN。毎日の食事や読み取り作業の面倒をラクにするツール。ブラウザ完結・登録不要・インストール不要。',
  keywords: [
    'NUKITORU', 'ヌキトル', 'NUKITORU FOOD', 'NUKITORU SCAN',
    '献立提案', '食材管理', '在庫管理',
    'JANコード抽出', 'QRコード抽出', 'バーコード読み取り',
    'EC事業者', '商品登録', '棚卸し', '無料ツール',
  ],
  // ── ファビコン ──
  icons: {
    icon: [
        ...
        <footer className="mt-4 border-t border-gray-200 dark:border-gray-800 py-4">
          <div className="max-w-3xl mx-auto px-4 text-center text-xs text-gray-400 dark:text-gray-600 space-y-1">
            ...
            <p className="mt-2">
              ...
              <a href="/license" className="text-[10px] tracking-[0.15em] text-gray-400 dark:text-gray-600 hover:text-blue-600 transition-colors">ライセンスキー</a>
                <span className="text-gray-600 dark:text-gray-700"> · </span>
