      ...
      {!isDone && (
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2 pt-1">
            ...
            <a href="/watermark" className="h-10 border border-gray-100 dark:border-gray-800 hover:border-blue-600 flex items-center justify-center gap-1.5 text-[9px] tracking-[0.15em] text-gray-400 dark:text-gray-600 hover:text-blue-600 uppercase transition-colors">ウォーターマーク追加<span className="text-blue-500 ml-1">PRO</span></a>
          </div>
