      ...
      {!isDone && (
        <div className="space-y-3">
          ...
          <div className="flex gap-2 pt-1">
            <button onClick={() => setInventoryOpen(true)} className="flex-1 h-11 border border-gray-200 dark:border-gray-800 hover:border-gray-400 dark:hover:border-gray-600 flex items-center justify-center gap-2 text-[11px] tracking-[0.2em] font-medium text-gray-400 dark:text-gray-600 uppercase transition-colors">Inventory</button>
            <button onClick={() => setShowInventoryHistory(true)} className="h-11 px-4 border border-gray-100 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-600 text-gray-400 dark:text-gray-600 text-[11px] tracking-[0.15em] uppercase transition-colors">History</button>
          </div>
